...
import { FadeIn, SlideUp } from '../../components/animation/index';
...
const getCardClasses = (item: HeroNewsItem): string => {
    const baseClasses = 'rounded-10 overflow-hidden cursor-pointer';
...
const VideoCard = ({ item }: { item: HeroNewsItem }) => (
    <div className='relative w-full h-full overflow-hidden flex flex-col rounded-10'>
